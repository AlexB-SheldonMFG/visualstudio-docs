...
2. In **Solution Explorer**, select and hold the **DemoCalculatorTest** project, and then select **Add Reference** to open the **Add Reference** dialog box.

3. Go to the **Projects** tab, and then select the DemoCalculatorLib project to add the reference to the test project.

4. In **Solution Explorer**, select and hold **DemoCalculatorTest**, and then select **Set as StartUp Project**.
